...
public class _68_NoOfGivenStringIn2dCharArr {
    static int internalSearch(String needle, int row, int col, String[] hay,
                ...
                needle.charAt(xx) == hay[row].charAt(col))
        {
            ...
            if (xx == needle.length()){
                found = 1;
            }else{ // Through Backtrack searching in every directions
    ...
    static int searchString(String needle, String[] str,
