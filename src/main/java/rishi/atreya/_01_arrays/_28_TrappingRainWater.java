...
public class _28_TrappingRainWater {
    static int findWater(int[] arr){
        ...
        // Calculate the accumulated water element by element consider the amount
        // of water on i'th bar, the amount of water accumulated on this particular
